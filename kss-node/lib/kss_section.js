...
KssSection.prototype.childSections = function() {
	return this.data.childSections;
};

KssSection.prototype.addChildSection = function(childSection) {
	this.data.childSections.push(childSection);
};
